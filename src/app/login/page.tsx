        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-4 bg-[#f6f8f6] dark:bg-[#102216] font-sans">
            <div className="flex w-full max-w-sm flex-col items-center">
                <div className="mb-8 flex items-center justify-center gap-2">
                    <span className="material-symbols-outlined text-[#0D47A1] text-4xl">receipt_long</span>
                    <p className="text-2xl font-bold text-[#212121] dark:text-[#E0E0E0]">ScanFlow</p>
                </div>
                ...
                <div className="w-full space-y-4 pt-6">
                    <div className="relative">
                        ...
                        <input className="block w-full rounded-xl border-none bg-[#F1F3F4] dark:bg-[#2a3a2e] py-4 pl-14 pr-4 text-lg text-[#212121] dark:text-[#E0E0E0] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#0D47A1]" id="email" name="email" placeholder="Email" type="email" />
                    </div>
                    <div className="relative">
                        ...
                        <input className="block w-full rounded-xl border-none bg-[#F1F3F4] dark:bg-[#2a3a2e] py-4 pl-14 pr-4 text-lg text-[#212121] dark:text-[#E0E0E0] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#0D47A1]" id="password" name="password" placeholder="Password" type="password" />
                    </div>
                </div>

                <div className="flex w-full items-center justify-between mt-4">
                    <div className="flex items-center">
                        <input className="h-4 w-4 rounded border-gray-300 bg-[#F1F3F4] text-[#0D47A1] focus:ring-[#0D47A1] dark:border-gray-600 dark:bg-[#2a3a2e] dark:ring-offset-[#102216]" id="remember-me" name="remember-me" type="checkbox" />
                        <label className="ml-2 block text-sm text-[#212121] dark:text-[#E0E0E0]" htmlFor="remember-me">Remember Me</label>
                    </div>
                    <a className="text-sm font-medium text-[#0D47A1] hover:underline" href="#">Forgot Password?</a>
                </div>

                <div className="flex w-full flex-col items-stretch pt-6">
                    <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-[#0D47A1] text-white text-base font-bold leading-normal tracking-[0.015em] w-full hover:bg-[#0D47A1]/90 transition-colors">
                        <span className="truncate">Log In</span>
                    </button>
                </div>

                <p className="text-[#212121]/80 dark:text-[#E0E0E0]/80 text-sm font-normal leading-normal pt-8 text-center">
                    Don't have an account? <Link className="font-bold text-[#0D47A1] hover:underline" href="#">Sign up</Link>
                </p>
            </div>
        </div>
    );
